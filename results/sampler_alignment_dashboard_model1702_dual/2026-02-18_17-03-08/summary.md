...
| Metric | Toy | Real 4K |
|---|---:|---:|
| `acceptance_rate` | 0.3625 | 0.9839 |
| `rescue_rate` | 0.375 | 0 |
| `median_hit_step` | 3 | nan |
| `proposal_alignment_outside_mean` | 0.9871 | -0.01271 |
| `accepted_alignment_outside_mean` | 0.6434 | -0.009465 |
| `proposal_opposition_rate_outside` | 0.001786 | 0.5089 |
| `accepted_opposition_rate_outside` | 0.001786 | 0.4929 |
| `first_step_abs_alignment_principal_mean` | 0.6405 | 0.434 |
| `first_step_alignment_to_manifold_mean` | 0.9946 | 0.1211 |
| `delta_logdet_inv_mean` | 5.956 | -0.01011 |
| `delta_logdet_inv_median` | 0 | -0.008629 |
| `escaped_count` | 0 | 0 |
