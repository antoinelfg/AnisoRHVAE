...
| Metric | Toy | Real 4K |
|---|---:|---:|
| `acceptance_rate` | 0.9969 | 0.9766 |
| `rescue_rate` | 0.0125 | 0 |
| `median_hit_step` | 8 | nan |
| `proposal_alignment_outside_mean` | 0.114 | -0.01004 |
| `accepted_alignment_outside_mean` | 0.112 | -0.02374 |
| `proposal_opposition_rate_outside` | 0.425 | 0.5062 |
| `accepted_opposition_rate_outside` | 0.425 | 0.5016 |
| `first_step_abs_alignment_principal_mean` | 0.6397 | 0.8636 |
| `first_step_alignment_to_manifold_mean` | 0.134 | 0.05895 |
| `delta_logdet_inv_mean` | 0.9199 | -0.001168 |
| `delta_logdet_inv_median` | 0.1084 | -0.02488 |
| `escaped_count` | 0 | 0 |
