...
| Volume contrast | 2.393 | Manifold should have higher log det(G_inv) than far void | contrast > 0 | PASS |
| Monotonic shells | true | Determinant should decrease from manifold to void | True | PASS |
| Void force alignment | 0.9451 | Volume force should point toward manifold on average outside | mean cosine > 0 | PASS |
| Void opposition rate | 0.02688 | Too many opposite arrows indicate unstable rescue dynamics | rate < 0.35 | PASS |
