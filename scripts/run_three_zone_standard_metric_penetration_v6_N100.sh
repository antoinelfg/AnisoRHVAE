...
"${PYTHON_BIN}" scripts/quick/visualize_rhmc_three_zones_real_metric.py \
  --model_path outputs/low_data_models/ellipses_auto_scaling_v6/aniso/N100/seed013/2026-02-23_10-57-58 \
  ...
  --output_dir results/rhmc_standard_metric_N100_penetration \
  "$@"
