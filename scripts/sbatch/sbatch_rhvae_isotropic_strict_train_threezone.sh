#!/usr/bin/env bash
#SBATCH --job-name=rhvae_iso_strict
#SBATCH --output=logs/rhvae_iso_strict_%j.out
#SBATCH --error=logs/rhvae_iso_strict_%j.err
...
BENCH_CONFIG="${BENCH_CONFIG:-configs/benchmark_rhvae_isotropic_strict_train_threezone.yaml}"
...
echo "=========================================="
echo "RHVAE Isotropic Strict Train+ThreeZone"
echo "=========================================="
...
echo "=========================================="
echo "[sbatch_rhvae_iso_strict] cmd: ${CMD[*]}"

"${CMD[@]}"

echo "[sbatch_rhvae_iso_strict] complete"
