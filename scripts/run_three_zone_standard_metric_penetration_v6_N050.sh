...
"${PYTHON_BIN}" scripts/quick/visualize_rhmc_three_zones_real_metric.py \
  --model_path outputs/low_data_models/ellipses_auto_scaling_v6/aniso/N050/seed013/2026-02-23_10-40-57 \
  ...
  --output_dir results/rhmc_standard_metric_N050_penetration \
  "$@"
